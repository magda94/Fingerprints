...
private:
	...
	void checkBranchNeighborhoodInWindow(int orgX, int orgY, int x, int y, int windowSize, int** windowTab);
	bool checkEndWindowTable(int windowSize, int** windowTable);
